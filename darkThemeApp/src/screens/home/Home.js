...
import { HeaderProduct, TextButton, TextInput,Lines, BottomTab, ProdcutsList } from "../../components";
...
const Home = (props) => {
 ...
 const [headerImage , setHeaderImage] =useState (DummyDAta[imageIndex])
  ...
  return (
    ...
    <TextButton  text ={'See All'} handlePress ={()=>navigation.navigate(RouterNames.PRODUCTS,{Data:DummyData})}/>
      </View>
